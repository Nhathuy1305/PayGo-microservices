...
import (
	...
	dbrepo2 "notify-service/internal/app/repository"
	"notify-service/internal/app/repository/dprepo"
	"strconv"
)
...
func handleNotify(account *models.Account, notify models.TransactionSaga) *models.MailData {
	...
	mail.From = "dnhuy.ityu@gmail.com"
